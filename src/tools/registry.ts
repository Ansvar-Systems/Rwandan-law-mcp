...
import { getRwandanImplementations, type GetRwandanImplementationsInput } from './get-rwandan-implementations.js';
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Rwandan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from a Rwandan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Rwandan legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Rwandan statutes simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Format a Rwandan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Rwandan statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get international legal instruments that a Rwandan statute references or aligns with. ' +
  ...
  },
  {
    ...
    description:
      'Find all Rwandan statutes that reference or align with a specific EU directive or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Rwandan legislation. ' +
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within a Rwandan statute. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_rwandan_implementations':
          result = await getRwandanImplementations(db, args as unknown as GetRwandanImplementationsInput);
          break;
